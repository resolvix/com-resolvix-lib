 ...
 * @param <M> the type of the fifth argument to the operation
 */
@FunctionalInterface
public interface PentConsumer<I, J, K, L, M> {
     ...
     * @param m the fifth argument
     */
    void accept(I i, J j, K k, L l, M m);
}